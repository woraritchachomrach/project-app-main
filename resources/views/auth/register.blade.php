        ...
        <form method="POST" action="{{ route('register') }}" class="space-y-6">
            ...
            <div>
                ...
                <div class="mt-1 relative rounded-md shadow-sm">
                    ...
                    <x-text-input id="name" class="block w-full pl-10 py-3 border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500" 
            ...
            <div>
                ...
                <div class="mt-1 relative rounded-md shadow-sm">
                    ...
                    <x-text-input id="password_confirmation" class="block w-full pl-10 py-3 border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500"
            ...
            <div class="flex items-center justify-between">
                ...
                <x-primary-button class="px-6 py-3 bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                    {{ __('Register') }}
                </x-primary-button>
            </div>
        </form>
